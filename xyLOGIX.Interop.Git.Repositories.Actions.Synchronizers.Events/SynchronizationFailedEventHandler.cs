namespace xyLOGIX.Interop.Git.Repositories.Actions.Synchronizers.Events
{
    ...
    /// <param name="e">A <see cref="T:xyLOGIX.Interop.Git.Repositories.Actions.Synchronizers.Events.SynchronizationFailedEventArgs" /> that contains the event data.</param>
