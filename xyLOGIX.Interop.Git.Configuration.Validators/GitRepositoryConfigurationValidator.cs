...
namespace xyLOGIX.Interop.Git.Configuration.Validators
{
    /// <summary>
    /// Methods to validate the values of the properties of objects that are instances
    /// of those which implement the
    /// <see
    ///     cref="T:xyLOGIX.Interop.Git.Interfaces.IGitRepositoryGitRepositoryConfiguration" />
    /// interface.
    /// </summary>
    public static class GitRepositoryConfigurationValidator
    {
        ...
        /// <see
        ///     cref="T:xyLOGIX.Interop.Git.GitRepositoryConfigurations.GitRepositoryConfiguration" />
        /// , the
