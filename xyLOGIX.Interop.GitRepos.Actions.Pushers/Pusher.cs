...
namespace xyLOGIX.Interop.GitRepos.Actions.Pushers
{
    /// <summary>
    ...
    public class Pusher : GitRepositoryAction, IPusher
    {
        ...
        /// <see cref="T:xyLOGIX.Interop.GitRepos.Actions.Pushers.Pusher" />.
        /// </summary>
        [Log(AttributeExclude = true)]
        ...
        public void Push()
        {
            ...
            try
            {
                ...
                GitRepository.Network.Push(
                    remote, @"refs/heads/master", options
                );
            }
            catch (Exception ex)
            {
        ...
        /// Raises the
        /// <see
        ///     cref="E:xyLOGIX.Interop.GitRepos.Pushers.Pusher.PushCompleted " />
        /// event.
        /// </summary>
        ...
        /// Raises the
        /// <see
        ///     cref="E:xyLOGIX.Interop.GitRepos.Pushers.Pusher.PushFailed " />
        /// event.
        /// </summary>
        /// <param name="e">
        /// A
        /// <see
        ///     cref="T:xyLOGIX.Interop.GitRepos.Events.PushFailedEventArgs" />
        /// that
        ...
        /// Raises the
        /// <see
        ///     cref="E:xyLOGIX.Interop.GitRepos.Pushers.Pusher.PushStarted " />
        /// event.
        /// </summary>
