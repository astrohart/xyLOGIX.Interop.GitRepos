...
namespace xyLOGIX.Interop.GitRepos.Actions.Synchronizers.Events
{
    /// <summary>
    ...
    {
        /// <summary>
        /// Constructs a new instance of <see cref="T:xyLOGIX.Interop.GitRepos.Actions.Synchronizers.Events.SynchronizationFailedEventArgs" /> and returns a reference to it.
        /// </summary>
