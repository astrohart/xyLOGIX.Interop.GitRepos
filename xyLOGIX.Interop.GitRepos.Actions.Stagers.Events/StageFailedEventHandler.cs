namespace xyLOGIX.Interop.GitRepos.Actions.Stagers.Events
{
    /// <summary>
    ...
    /// <param name="e">
    /// A
    /// <see cref="T:xyLOGIX.Interop.GitRepos.Actions.Stagers.Events.StageFailedEventArgs" /> that contains
    /// the event data.
    /// </param>
