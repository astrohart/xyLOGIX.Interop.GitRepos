...
using LibGit2Sharp;
using System;
using xyLOGIX.Interop.Git.Configuration.Helpers;
using xyLOGIX.Interop.Git.Configuration.Validators;
using xyLOGIX.Interop.Git.Repositories.Actions.Events;
using xyLOGIX.Interop.Git.Repositories.Actions.Exceptions;
using xyLOGIX.Interop.Git.Repositories.Actions.Interfaces;

namespace xyLOGIX.Interop.Git.Repositories.Actions
{
    /// <summary>
    ...
    public abstract class GitRepositoryAction : IGitRepositoryAction
    {
        ...
        /// <summary>
        /// Raises the <see
        /// cref="E:xyLOGIX.Interop.Git.Changes.Stager.GitRepositoryAttached"/> event.
        /// </summary>
        /// <param name="e">
        /// A <see
        /// cref="T:xyLOGIX.Interop.Git.Events.GitRepositoryAttachedEventArgs"/>
        ...
        /// <summary>
        /// Raises the <see
        /// cref="E:xyLOGIX.Interop.Git.Changes.Stager.GitRepositoryDetached.GitRepositoryDetached"/> event.
        /// </summary>
        ...
        /// if the <see
        /// cref="P:xyLOGIX.Interop.Git.Repositories.Actions.GitRepositoryAction.GitRepository"/>
        ...
        /// </summary>
        /// <exception cref="T:xyLOGIX.Interop.Git.Repositories.Actions.Exceptions.GitRepositoryNotConfiguredException">
        /// Thrown if the repository does not have a valid object that
        /// implements the <see
        /// cref="T:xyLOGIX.Interop.Git.Interfaces.IGitRepositoryConfiguration"/>
