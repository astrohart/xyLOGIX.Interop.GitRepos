...
namespace xyLOGIX.Interop.Git.Repositories.Actions.Stagers.Events
{
    /// <summary>
    ...
    public class StageFailedEventArgs : EventArgs
    {
        ...
        /// <see cref="T:xyLOGIX.Interop.Git.Repositories.Actions.Stagers.Events.StageFailedEventArgs" /> and returns a
        /// reference to it.
        /// </summary>
