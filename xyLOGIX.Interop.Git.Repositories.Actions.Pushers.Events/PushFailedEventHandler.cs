namespace xyLOGIX.Interop.Git.Repositories.Actions.Pushers.Events
{
    /// <summary>
    ...
    /// <param name="e">
    /// A
    /// <see cref="T:xyLOGIX.Interop.Git.Repositories.Actions.Pushers.Events.PushFailedEventArgs" /> that
