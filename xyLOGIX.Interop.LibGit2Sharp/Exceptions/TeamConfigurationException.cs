...
namespace xyLOGIX.Interop.LibGit2Sharp.Exceptions
{
    ...
    public class TeamConfigurationException : InvalidOperationException
    {
        ...
        /// implements the <see cref="T:xyLOGIX.Interop.LibGit2Sharp.Interfaces.ITeam" />
        /// interface. This object represents the Team that this exception is talking
        /// about.
        /// </param>
        /// <param name="message">
        /// (Optional.) Message, if any, to be added to this
        /// exception's default message.
        /// </param>
        /// <exception cref="T:System.ArgumentNullException">
        /// Thrown if the
        /// <paramref name="team" /> parameter is passed a null reference.
        /// </exception>
        ...
        /// <see cref="T:xyLOGIX.Interop.LibGit2Sharp.Interfaces.ITeam" /> interface that
        /// represents the Team this exception is talking about.
        /// </summary>
