...
namespace xyLOGIX.Interop.GitRepos.Interfaces
{
    /// <summary>
    ...
    public interface ITeam : IDisposable
    {
        ...
        /// <see cref="T:xyLOGIX.Interop.GitRepos.Interfaces.IGitRepositoryConfiguration" />
        /// interface.
        /// </summary>
        ...
        /// <summary>
        /// Gets a reference to an instance of an object that implements the
        /// <see cref="T:xyLOGIX.Interop.GitRepos.Interfaces.ISynchronizer" />
        /// interface.
        /// </summary>
        ...
        /// <see cref="M:xyLOGIX.Interop.GitRepos.Team.CommitAll" /> method if no
        ...
        /// Use two newline characters, '\n\n', in the message to separate the short commit
        /// message from a detailed commit message.  This method simply calls the
        /// <see cref="M:xyLOGIX.Interop.GitRepos.Team.CommitAllAndPush" />
        /// method if no
        /// <paramref name="files" /> are specified.
        /// </remarks>
        /// <exception
        ...
        /// Use two newline characters, '\n\n', in the message to separate the short commit
        /// message from a detailed commit message.  This method simply calls the
        /// <see cref="M:xyLOGIX.Interop.GitRepos.Team.CommitAllAndSync" />
        /// method if no
        /// <paramref name="files" /> are specified.
        /// </remarks>
        /// <exception
